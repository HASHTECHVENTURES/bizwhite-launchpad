    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="text-center max-w-4xl lg:max-w-5xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#1a1a1a] mb-6 sm:mb-8 animate-fade-in">
            BizWhite at a Glance
          </h2>
          <div className="h-1 w-20 sm:w-24 bg-[#ff6b35] mx-auto mb-6 sm:mb-8 animate-fade-in"></div>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed animate-fade-in">
