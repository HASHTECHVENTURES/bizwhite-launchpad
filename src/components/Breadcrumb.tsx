...
const Breadcrumb = ({ pageName, backgroundImage }: BreadcrumbProps) => {
  ...
  return (
    <section
      className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 lg:pb-24 bg-cover bg-center"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-white mb-3 sm:mb-4 animate-fade-in leading-tight">{pageName}</h1>
        <div className="h-1 w-16 sm:w-20 md:w-24 bg-[#ff6b35] animate-fade-in"></div>
      </div>
    </section>
  );
};
