...
import heroImage from "@/assets/hero-bizwhite.jpg";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <div className="animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Leading Manufacturers & Exporters of Industrial Minerals
          </h1>
          <p className="text-xl md:text-2xl text-white/95 mb-12 max-w-3xl mx-auto leading-relaxed">
            Delivering consistent quality in Bentonite, Bleaching Earth, Kaolin, Quartz Silica Sand, Clay Catalyst, Feldspar and Sodium Feldspar to global industries.
          </p>
