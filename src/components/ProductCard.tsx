...
const ProductCard = ({ title, description, image, href }: ProductCardProps) => {
  ...
  return (
    <Card className="overflow-hidden group hover:shadow-2xl transition-all duration-500 border-2 border-gray-700 hover:border-[#ff6b35] bg-white hover:-translate-y-2 flex flex-col h-full">
      ...
      <CardFooter className="px-4 sm:px-6 pb-4 sm:pb-6 pt-0">
        <Button variant="ghost" className="group/btn text-[#ff6b35] hover:text-[#ff6b35] hover:bg-[#ff6b35]/10 p-0 text-sm sm:text-base font-semibold w-full justify-start transition-all duration-300" onClick={handleClick}>
          Read More
